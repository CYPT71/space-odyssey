...
window.addEventListener('universeReady', () => {
  ...
  const steps = [
    { selector: '#hud-minimap', title: 'KNOWN OBJECTS', text: 'Liste des galaxies 🌌, poches de gaz 🌫️, nébuleuses ✨ et planètes 🌍. Cliquez pour téléporter.' },
    { selector: '#compass-bar', title: 'COMPASS', text: 'Indique les cibles visibles. La plus proche est surlignée.' },
    { selector: '#controls-hint', title: 'PROPULSION AVANT', text: 'Appuie sur Z pour avancer.', keys: ['z'] },
    { selector: '#controls-hint', title: 'PROPULSION ARRIÈRE', text: 'Appuie sur S pour reculer.', keys: ['s'] },
    { selector: '#controls-hint', title: 'YAW GAUCHE/DROITE', text: 'Q pour gauche, D pour droite.', keys: ['q','d'] },
    { selector: '#controls-hint', title: 'ASCENDRE/DESCENDRE', text: 'SPACE pour monter, SHIFT pour descendre.', keys: [' ', 'Shift'] },
    { selector: '#controls-hint', title: 'STOP D’URGENCE', text: 'Appuie sur C pour arrêt immédiat.', keys: ['c'] },
    { selector: '#warp-boost', title: 'WARP BOOST', text: 'Active le warp pour un saut rapide (bouton ou maintenir vitesse). Clique sur le bouton pour continuer.' },
  ];
  tutorial.open(steps);
